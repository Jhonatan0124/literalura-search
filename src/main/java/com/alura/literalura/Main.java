...
public class Main {
    static BookService bookService; // Declaramos la variable bookService

    public static void main(String[] args) {
        bookService = new BookService(); // Creamos una instancia de BookService

        SwingUtilities.invokeLater(() -> {
            JFrame frame = new JFrame("Literalura App");
